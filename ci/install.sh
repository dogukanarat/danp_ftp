...
print_info "  - Headers: $INSTALL_PREFIX/include/danp_ftp/"
print_info "  - CMake config: $INSTALL_PREFIX/lib/cmake/danp_ftp/"
echo ""
...
echo "  find_package(danp_ftp REQUIRED)"
echo "  target_link_libraries(your_target PRIVATE danp_ftp::danp_ftp)"
echo ""
