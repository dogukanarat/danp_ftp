...
- Test executable: `build/test/test_danp_ftp`
...
**Output:**
- Optimized library: `build/danpftp_project.a`
...
- **User install** (`~/.local`):
  - Libraries: `~/.local/lib/`
  - Headers: `~/.local/include/danp_ftp/`
  - CMake config: `~/.local/lib/cmake/danp_ftp/`

- **Custom prefix** (`/opt/mylibs`):
  - Libraries: `/opt/mylibs/lib/`
  - Headers: `/opt/mylibs/include/danp_ftp/`
  - CMake config: `/opt/mylibs/lib/cmake/danp_ftp/`
...
- Check test assertions in `test/test_danp_ftp.c`
