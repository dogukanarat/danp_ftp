...
```
danp_ftp/
├── include/danp_ftp/            # Public headers
│   ├── danp_ftp.h               # Main API header
│   └── danp_ftp_types.h         # Common types and definitions
├── src/                            # Implementation
│   ├── danp_ftp.c               # Core implementation
│   └── danp_ftp_int.c           # Internal utilities
├── test/                           # Unit tests (Unity framework)
│   ├── CMakeLists.txt              # Test build configuration
│   ├── test_danp_ftp.c          # Example test file
│   └── README.md                   # Testing guide
├── cmake/                          # CMake modules
│   └── danp_ftpConfig.cmake.in  # Package config template
...
clang-format -i include/danp_ftp/myheader.h
```
...
# Run only danp_ftp tests
ctest -L danp_ftp
```

### Writing Tests

See [test/README.md](file:///home/dogukanarat/workspace/danp_ftp/test/README.md) for a comprehensive guide on writing tests with Unity.
...
- Header files to `/usr/local/include/danp_ftp/`
- CMake config files to `/usr/local/lib/cmake/danp_ftp/`
...
find_package(DanpFtp REQUIRED)

# Create your executable
add_executable(myapp main.c)

# Link against the library
target_link_libraries(myapp PRIVATE DanpFtp::DanpFtp)
```
...
GitHub: [dogukanarat/danp_ftp](https://github.com/dogukanarat/danp_ftp)
